...
#
    ...
    def Hamiltonian_p(self, kv):
        ...
        M = 12.*np.asarray([
                ...
                [np.dot(self.g0_arr2,self.Epxx[6:])[0],  np.dot(self.gyx_arr2,self.Exy[6:])[0],  np.dot(self.gzx_arr2,self.Exz[6:])[0],
                    np.dot(self.g0_arr,self.Epxx[:6])[0],  np.dot(self.gyx_arr,self.Exy[:6])[0],  np.dot(self.gzx_arr,self.Exz[:6])[0]], 
                [np.dot(self.gyx_arr2,self.Exy[6:])[0],  np.dot(self.g0_arr2,self.Epyy[6:])[0],  np.dot(self.gzy_arr2,self.Eyz[6:])[0], 
                    np.dot(self.gyx_arr,self.Exy[:6])[0],  np.dot(self.g0_arr,self.Epyy[:6])[0],  np.dot(self.gzy_arr,self.Eyz[:6])[0]], 
